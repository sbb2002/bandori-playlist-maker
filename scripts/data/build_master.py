...
근거:
    - docs/PRD.md §6
    - docs/reports/2026-07-10-data-team-lead-ticket-design.md §⑤ 티켓1,
      §④ B1(표본 부족 밴드 n>=10 정책)·B2(data/ 복사 정책 / 컬럼 스펙)
    - docs/reports/2026-07-10-data-team-tickets-2-3-review.md (video_id/camelot
      컬럼은 기존 모듈 import로 채울 것 — 재구현 금지)
...
실행:
    python scripts/data/build_master.py
"""
...
# .../bandori-playlist-maker/scripts/data/build_master.py
#   .parent      -> scripts/data
#   .parent.parent -> scripts
#   .parent.parent.parent -> bandori-playlist-maker
#   .parent.parent.parent.parent -> myprojects
