...
실행:
    python auto-loader/data/build_master.py
"""
...
# .../bandori-playlist-maker/auto-loader/data/build_master.py
#   .parent      -> auto-loader/data
#   .parent.parent -> auto-loader
...
# 기준(예: 명시적 밴드 차단)을 위해 남겨둔다. (main 대상: PR #34)
_MIN_BAND_SAMPLE = 1
