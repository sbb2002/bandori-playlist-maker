...
# selection_pipeline lives at topic/20260718_selection_pipeline, a sibling of
# topic/20260720_vector_embedding. TOPIC_DIR (== .../topic) is one level up, not two —
...
# of repo_root/topic/20260720_vector_embedding/...), causing FileNotFoundError on
