...
DESIGN_v3.md §1: same method as v1 arm2 (topic/20260718_selection_pipeline/03_lyric_candidates.py) —
...
def expand_queries(client):
    ...
    for query_id, spec in config.QUERIES.items():
        ...
        # Exact template reused from topic/20260718_selection_pipeline/03_lyric_candidates.py (v1 arm2).
        expand_prompt = (
