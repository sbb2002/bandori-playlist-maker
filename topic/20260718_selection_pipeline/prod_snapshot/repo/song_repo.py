...
#   [DESIGN_v3.md §1 vendoring: 원본은 parents[3]==.../src로 scripts/data를 찾았으나, 이 파일은
#    topic/20260718_selection_pipeline/prod_snapshot/repo/에 스냅샷됐으므로 형제 디렉토리로 직접 지정한다
#    — 로직 변경 아니고 vendoring에 따른 경로 배선만 조정]
_SCRIPTS_DATA = Path(__file__).resolve().parents[1] / "scripts_data"
