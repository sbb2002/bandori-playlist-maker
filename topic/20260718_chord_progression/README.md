...
- **오디오 파일**: `topic/20260720_vector_embedding/src/method-1/work/stems_full/htdemucs/<tag>/no_vocals.wav` (2-stem 분리 완료)
...
```
topic/20260718_chord_progression/
...
→ stems_full 디렉토리 확인. `topic/20260720_vector_embedding/src/method-1/work/stems_full/htdemucs/<tag>/no_vocals.wav` 경로 확인.
