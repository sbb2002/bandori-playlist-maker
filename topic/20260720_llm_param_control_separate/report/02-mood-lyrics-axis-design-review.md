...
관련 세부 조사·수정 내역은 `topic/20260720_audio_feats_analysis/report/06`에 있고, 이 문서는 그
...
찾아 수정 완료(`topic/20260720_audio_feats_analysis/src/method-1/config.py`). 661곡 전체 재산출은
...
- `topic/20260720_audio_feats_analysis/report/06-key-profile-roll-bug.md`(key 버그, 전체 피쳐
  신뢰도 표)
- `topic/20260720_vector_embedding/report/02-acoustic_feature_audit.md`(`mode_score` 스코프 한계)
- `topic/20260720_vector_embedding/report/03-lyrics_acoustic_association.md`(가사-음향 직교성,
  n=661 정량 근거)
- `topic/20260720_vector_embedding/report/01-lyrics_vector-searching.md`(Phase 1 "슬픈 노래" 0.3/10
  실패 사례)
- `topic/20260718_selection_pipeline/prod_snapshot/domain/selection_stage_c.py`(Stage A/B/C 현재
