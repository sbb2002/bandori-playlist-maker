...
CSV_PATH = "topic/20260720_audio_feats_analysis/out/audio_feats.csv"
...
def main():
    ...
    pilot_output.to_csv('topic/20260720_audio_feats_analysis/out/pilot_15_results.csv', index=False)
    print(f"\nPilot results saved to: topic/20260720_audio_feats_analysis/out/pilot_15_results.csv")
