# 포스트-파일럿 백로그 (main docs/BACKLOG.md 이관본)

- 일자: 2026-08-24
- 사유: `main`의 `docs/`는 앱 구조·설계를 설명하는 문서만 남기기로 함(레포 오너 결정,
  2026-08-24) — 이 파일은 우선순위·날짜가 붙은 "다음 패치 아이디어" 목록(C티어)이라
  `document-archive`로 이관. 원본은 PR로 `main`에서 삭제.
