...
| [`topic/20260731_audio_feats_revised/`](topic/20260731_audio_feats_revised/README.md) | `energy`/`valence` 산출 파이프라인 전면 재설계 — 기존 프록시·`energy_full`·`mode_score`는 반면교사로만 취급, 코드·공식 재참조 없이 처음부터 재산출 | **종결(2026-08-02)** — 11개 지표 736곡 전수 산출→사용가능/보류/사용불능 분류→다중공선성(VIF) 검증까지 완료, 최종 파라미터 9개 확정(`report_final.md`) |
