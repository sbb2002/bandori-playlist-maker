...
| [`topic/energy_full_validation/`](topic/energy_full_validation/README.md) | `energy`/`energy_full`과 tempo·brightness·원시 오디오 피처(zcr/spectral/HPSS 등)의 관계, GT_MISJUDGED 재검증 | 집계 상관은 확인, GT_MISJUDGED 핵심 사례(처救生) 미해결 발견 |
