...
4. 시나리오별 pass/fail 게이트를 평가한다(임계값은 docs/research/2026-07-11-verification-methodology.md).
...
# 게이트 임계값 근거: docs/research/2026-07-11-verification-methodology.md §4.
