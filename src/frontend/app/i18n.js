...
const I18N_TABLE = {
  ...
  "options.sparseHatchHint": { ko: "빗금 친 영역은 그 근처에 실제로 곡이 적다는 뜻이에요 — 골라도 되지만 전혀 상관없는 곡이 나올 수 있어요!", ja: "🔸 斜線のある場所は、その辺りに実際の曲が少ないという意味です — 選んでもいいですが、参考にしてください。", en: "🔸 The hatched areas mean there aren't many songs near there — you can still pick it, just FYI.", "zh-Hans": "🔸 有斜线的区域表示那附近实际上歌曲较少——仍可以选，仅供参考。", "zh-Hant": "🔸 有斜線的區域表示那附近實際上歌曲較少——仍可以選，僅供參考。" },
  "options.recommendBandHint": { ko: "🟢 초록 밴드는 후보 곡이 충분한 추천 구간이에요.", ja: "🟢 緑のバンドは候補曲が十分にある、おすすめの範囲です。", en: "🟢 The green band marks the recommended range with plenty of candidate songs.", "zh-Hans": "🟢 绿色区域是候选歌曲充足的推荐范围。", "zh-Hant": "🟢 綠色區域是候選歌曲充足的推薦範圍。" },
