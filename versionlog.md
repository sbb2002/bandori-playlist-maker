...
<!-- 신곡 오토로더(src/scripts/autoloader/)는 main에 머지하지 않는 영구 tool 브랜치
     (feature/song-autoloader)에서 운영한다 — 배포 앱 릴리스가 아니므로 여기 기록하지 않는다.
     툴 변경 이력·사용법은 src/scripts/README.md 참조. (2026-07-15 결정) -->
